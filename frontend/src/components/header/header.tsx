    ...
    <header className={styles.header}>
      <div className={styles.header__container}>
        ...
        {!user && (
          ...
          >
            <span title='Авторизация' className={styles['header__icon-text']}>
              Войти
            </span>
          </Link>
        )}
        {user && (
          <>
            ...
            >
              <span className={styles['header__icon-text']}>Выйти</span>
            </Link>
            <Link
              title='Перейти в профиль'
              to={AppRoute.ProfileOrders}
              onClick={() => {}}
              className={clsx(styles.header__icon, styles.header__profile)}
            >
              <span className={styles['header__icon-text']}>Профиль</span>
            </Link>
          </>
        )}
      </div>
