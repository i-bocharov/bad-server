...
const RouteComponent = () => {
  ...
  useEffect(() => {
    ...
    if (refreshToken) {
      ...
      checkUserAuth()
        .unwrap()
        .finally(() => authCheck()) // В любом случае (успех или провал) мы завершаем проверку.
    } else {
      // Если refreshToken НЕТ, пользователь точно не авторизован.
    ...
    <>
      ...
      <Routes location={background || location}>
        ...
        >
          ...
          <Route path={AppRoute.AdminOrders} element={<AdminOrders />} />
          <Route path={AppRoute.AdminCustomers} element={<AdminCustomers />} />
        </Route>
        <Route
        ...
        >
          <Route path={AppRoute.ProfileOrders} element={<ProfileOrders />} />
        </Route>
